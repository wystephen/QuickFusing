...
if __name__ == '__main__':
    ...
    for exam_id in [5, 3]:
        for particle_num in [10, 20, 50, 100, 500, 1000, 2000, 2500, 3000, 5000, 8000, 10000, 15000, 20000, 30000,
                             40000, 50000,
                             60000]:
            for t_sigma in [0.5, 1.0, 2.0, 4.0, 5.0, 10.0]:
                for eval_sigma in [1.0, 2.0, 4.0, 5.0, 10.0]:
